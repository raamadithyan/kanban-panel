...
function TaskCard({task,deleteTask}:TaskProps) {


	return (
		<div 
			className="
				bg-rose-800 p-2.5 leading-[5rem]
			...
			<button  onClick={() =>deleteTask(task.id)}
				className="absolute right-4 top-[38%] transition-opacity duration-500 opacity-0 group-hover:opacity-100"
			>
