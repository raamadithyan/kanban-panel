...
const ColumnContainer = ({column,deleteColumn,updateColumn,createTask,tasks,deleteTask}: Props) => {
 ...
 const [editmode, setEditMode] = useState(false)
	...
	return (
		...
		<div ref={setNodeRef} style={style}   className="flex  gap-4 relative">
			...
			<div {...attributes} {...listeners} className=" absolute top-0 flex items-center px-8 w-[350px] h-12 justify-between bg-neutral-900 z-10 ">
